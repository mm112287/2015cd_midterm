...
class Hello(object):
    ...
    <form method=\"post\" action=\"gear7\">
        <fieldset>
        <legend>40223124的7顆齒輪嚙合參數表單(會畫圖):</legend>
        齒數1:<br />
        <input type=\"text\" name=\"ng1\"><br />
        齒數2:<br />
    ...
    def spuraction(self, m=None, ng1=None,inp2=None):
        ...
        outString += self.menuLink()
        return outString
    #@+node:2015.20150512113138.1: *3* gear7
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def gear7(self, m=None, ng1=None, ng2=None, ng3=None, ng4=None, ng5=None, ng6=None, ng7=None, inp2=None):
        outString = ""
